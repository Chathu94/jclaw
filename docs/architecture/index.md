...
> Master index — primary AI retrieval entry point. Generated by `bmad-document-project` on **2026-06-29** via deep rescan; selected facts (version pins, memory subsystem, `/api/memories`, license) surgically corrected **2026-07-14** — and again on **2026-07-23** (status `alpha`→`beta`; the Prompts Library API + `/prompts`, `/memories`, `/apps` routes; frontend page count 20→23), and on **2026-08-07** (license `open-core`→source-available/PolyForm Noncommercial; root-docs filenames) — without a full regenerate.
>

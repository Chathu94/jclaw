...
description: Create, inspect, and edit Microsoft PowerPoint presentations and PPTX decks with reliable layouts, templates, placeholders, notes, charts, and visual QA.
version: 1.0.0
author: clawhub.ai/ivangdavila/powerpoint-pptx
tools: [documents, filesystem, exec]
commands: []
icon: 📊
---
## When to Use
